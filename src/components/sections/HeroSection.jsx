...
const HeroSection = () => {
  return (
    <section className="relative w-full h-[600px] flex items-center justify-center bg-gray-100 overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto flex flex-col items-center">
        ...
        <p className="text-xl md:text-3xl font-semibold text-white drop-shadow-md mb-8">
          Super fun, hands-on projects<br />delivered every month
        </p>
